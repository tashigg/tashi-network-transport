...
namespace Tashi.NetworkTransport
{
    ...
    public class TashiNetworkTransportEditor : Editor
    {
        ...
        private SerializedProperty m_MinBaseEventIntervalMicros;
        ...
        void OnEnable()
        {
            ...
            m_MinBaseEventIntervalMicros = m_Config.FindPropertyRelative("MinBaseEventIntervalMicros");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_MinBaseEventIntervalMicros, new GUIContent("Min Base Event Interval (μs): "));
