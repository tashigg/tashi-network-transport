...
namespace Tashi.ConsensusEngine
{
    ...
    public class Platform : IDisposable
    {
        ...
        [DllImport("tashi_platform", EntryPoint = "tce_init")]
        ...
        [DllImport("tashi_platform", EntryPoint = "tce_bound_address_get")]
        ...
        [DllImport("tashi_platform", EntryPoint = "tce_add_node")]
        ...
        [DllImport("tashi_platform", EntryPoint = "tce_start")]
        static extern Result tce_start(IntPtr platform);

        [DllImport("tashi_platform", EntryPoint = "tce_event_get")]
        static extern IntPtr tce_event_get(
            IntPtr platform,
            out Result result
        );

        [DllImport("tashi_platform", EntryPoint = "tce_send")]
        ...
        [DllImport("tashi_platform", EntryPoint = "tce_event_free")]
        static extern void tce_event_free(IntPtr consensusEvent);

        [DllImport("tashi_platform", EntryPoint = "tce_free")]
